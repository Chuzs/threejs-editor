...
function SidebarProjectRenderer(editor) {
  ...
  antialiasRow.add(
    new UIText(strings.getKey("sidebar/project/antialias")).setClass("Label")
  );
  ...
  shadowsRow.add(
    new UIText(strings.getKey("sidebar/project/shadows")).setClass("Label")
  );
  ...
  toneMappingRow.add(
    new UIText(strings.getKey("sidebar/project/toneMapping")).setClass("Label")
  );
