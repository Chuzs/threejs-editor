...
function MenubarView(editor) {
  ...
  option.setClass("option").addClass("toggle");
  option.setTextContent(strings.getKey("menubar/view/fullscreen"));
  option
    .onClick(function () {
      this.toggleClass("toggle-on", document.fullscreenElement === null);
    ...
    .toggleClass("toggle-on", document.fullscreenElement != null);
  options.add(option);

  // Leftbar
  option = new UIRow();
  option.setClass("option").addClass("toggle");
  option.setTextContent(strings.getKey("menubar/view/show_leftbar"));
  option
    .onClick(function () {
  ...
  option = new UIRow();
  option.setClass("option").addClass("toggle");
  option.setTextContent(strings.getKey("menubar/view/show_sidebar"));
  option
    .onClick(function () {
  ...
  const appearanceSubmenu = new UIPanel()
    .setPosition("fixed")
    .addClass("options")
    .setDisplay("none");
  ...
  option = new UIRow()
    .addClass("option")
    .addClass("toggle")
    .setTextContent("Skeleton Helpers")
    .onClick(function () {
